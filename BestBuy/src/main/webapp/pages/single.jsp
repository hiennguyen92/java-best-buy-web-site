...
<div class="content">
    ...
    <div class="content-grids">
        ...
        <div class="detalis-image-details">
            ...
            <div class="share">
                <ul>
                    <li> <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=${pageContext.request.requestURL}?${pageContext.request.queryString}"><img src="images/facebook.png" title="Facebook" /> Share on Facebook</a></li>
